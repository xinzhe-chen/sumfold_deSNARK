...
impl<E: Pairing> std::default::Default for MultilinearUniversalParams<E> {
    fn default() -> Self {
        Self {
            prover_param: MultilinearProverParam::<E>::default(),
            h_mask: vec![],
        }
    }
}
...
impl<E: Pairing> std::default::Default for MultilinearProverParam<E> {
    fn default() -> Self {
        Self {
            num_vars: 0,
            powers_of_g: vec![],
